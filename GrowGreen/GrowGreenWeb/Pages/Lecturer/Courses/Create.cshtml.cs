...
namespace GrowGreenWeb.Pages.Lecturer.Courses
{
    ...
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(GrowGreenContext context, IWebHostEnvironment environment, AccountService accountService)
        {
            _context = context;
...
int lecturerId = user.Id;
        ...
        public async Task<IActionResult> OnPostUploadAsync()
        {
            ...
            var file = Path.Combine(_environment.WebRootPath, "uploads", "courseThumbnail",
